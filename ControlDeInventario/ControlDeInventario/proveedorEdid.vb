...
Public Class proveedorEdid
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Rut_provTextBox.Text = ProveedorDataGridView.CurrentRow.Cells.Item(1).Value.ToString
        Nombre_provTextBox.Text = ProveedorDataGridView.CurrentRow.Cells.Item(2).Value.ToString
        DireccionTextBox.Text = ProveedorDataGridView.CurrentRow.Cells.Item(3).Value.ToString
        ComunaTextBox.Text = ProveedorDataGridView.CurrentRow.Cells.Item(4).Value.ToString
        CiudadTextBox.Text = ProveedorDataGridView.CurrentRow.Cells.Item(5).Value.ToString
        EmailTextBox.Text = ProveedorDataGridView.CurrentRow.Cells.Item(6).Value.ToString
        FonoTextBox.Text = ProveedorDataGridView.CurrentRow.Cells.Item(7).Value.ToString
