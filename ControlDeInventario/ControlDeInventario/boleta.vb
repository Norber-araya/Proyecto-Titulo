        ...
        Else
            ...
            If validador = 0 Then
                ...
                If Val(CantidadTextBox.Text) <= Val(Label2.Text) Then
                    ...
                    bdconexion.insertar_registro(documento, N_boletaTextBox.Text, Cod_productoTextBox.Text, PrecioTextBox.Text, CantidadTextBox.Text, FechaDateTimePicker.Text, rut, ingreso)
