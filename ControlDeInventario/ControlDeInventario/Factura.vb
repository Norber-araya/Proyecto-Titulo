    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            If DataGridView1.Rows.Count > 0 Then
                ...
                bdconexion.insertar_factura(N_facturaTextBox.Text, Rut_provTextBox.Text, NombrePro.Text, DireccionTextBox.Text, ComunaTextBox.Text, CiudadTextBox.Text, EmailTextBox.Text, FonoTextBox.Text, Rut_clienteTextBox.Text, DateTimePicker1.Text, ObservacionTextBox.Text, neto.Text, variable, total.Text)
                realizado = 0
                For Each Fila As DataGridViewRow In DataGridView1.Rows
