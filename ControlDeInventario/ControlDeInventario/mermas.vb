...
Public Class mermas
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Val(CantidadTextBox.Text) <= Val(Label2.Text) Then
            bdconexion.insertar_mermas(Cod_productoTextBox.Text, NombreTextBox.Text, CantidadTextBox.Text, FechaDateTimePicker.Text)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Label2.Text = ProductoDataGridView.CurrentRow.Cells.Item(2).Value.ToString
        Panel1.Visible = False
        Me.ProductoTableAdapter.Fill(Me.ControlinventarioDataSet.producto)
        Me.MermasTableAdapter.Fill(Me.ControlinventarioDataSet.mermas)
