...
Public Class FacturaVenta
    ...
    Public Sub numeracion()
        conexion.Open()
        Dim nun As String
        Dim comando = New SqlCommand("select * from factura_egreso ", conexion)
        Dim dr As SqlDataReader = comando.ExecuteReader()

        While dr.Read()
            nun = Convert.ToString(dr("n_factura"))
        End While


        nun = Val(nun) + 1
        N_facturaTextBox.Text = nun
        conexion.Close()
    End Sub
    Public Sub n_guia()
        conexion.Open()
        Dim comando = New SqlCommand("select * from guia_despacho ", conexion)
        Dim dr As SqlDataReader = comando.ExecuteReader()

        While dr.Read()
            numero_guia = Convert.ToString(dr("n_guia"))
        End While
        conexion.Close()
    End Sub
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Else
            bdconexion.select_factura_egreso(N_facturaTextBox.Text)
            If validador = 0 Then
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            ...
            If DataGridView1.Rows.Count > 0 Then
                ...
                resultado = MsgBox("Generar guia de despacho?", vbInformation + vbYesNo, "Mensaje de Alerta")

                Select Case resultado

                    Case 6 'Yes
                        bdconexion.insertar_factura_egreso(N_facturaTextBox.Text, Rut_provTextBox.Text, NombreTextBox.Text, DireccionTextBox1.Text, ComunaTextBox1.Text, CiudadTextBox1.Text, EmailTextBox1.Text, FonoTextBox1.Text, Rut_clienteTextBox1.Text, DateTimePicker1.Text, ObservacionTextBox.Text, Valor_netoTextBox.Text, IvaTextBox.Text, TotalTextBox.Text)
                        bdconexion.insertar_guia(N_facturaTextBox.Text, Rut_provTextBox.Text, NombreTextBox.Text, DireccionTextBox1.Text, ComunaTextBox1.Text, CiudadTextBox1.Text, EmailTextBox1.Text, FonoTextBox1.Text, Rut_clienteTextBox1.Text, DateTimePicker1.Text, ObservacionTextBox.Text, Valor_netoTextBox.Text, IvaTextBox.Text, TotalTextBox.Text)
                        n_guia()
                        realizado = 0
                        For Each Fila As DataGridViewRow In DataGridView1.Rows
                            ...
                            If Not Fila Is Nothing Then
                                ...
                                toll = Fila.Cells("Column5").Value
                                bdconexion.insertar_fac_deta2(N_facturaTextBox.Text, prod, nom, can, prec, toll)
                                bdconexion.insertar_detalle_guia(numero_guia, prod, nom, can, prec, toll)
                            End If
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        If realizado > 0 Then
            ...
            resultado = MsgBox("Está seguro de cancelar el documento?", vbInformation + vbYesNo, "Mensaje de Alerta")
