...
Public Class BD_conexion
    ...
    'REGISTROS'
    Public Sub insertar_registro(documento As String, n_documento As Integer, id_producto As String, cantidad As Integer, fecha As Date, usuario As String, tipo As String)

        conectar()

        comando = New SqlCommand("INSERT INTO  [registro] ([documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo])  VALUES ('" & documento & "','" & n_documento & "','" & id_producto & "','" & cantidad & "','" & fecha & "','" & usuario & "','" & tipo & "')", conexion)
        comando.ExecuteNonQuery()
