...
Public Class BD_conexion
    ...
    Public Sub insertar_prod(cod_producto As String, producto As String, precio As Double)
        ...
        Else
            ...
            comando = New SqlCommand("INSERT INTO [producto] ([cod_producto], [producto], [cantidad], [precio]) VALUES ('" & cod_producto & "','" & producto & "','" & cantidad & "','" & precio & "')", conexion)
            comando.ExecuteNonQuery()
    ...
    Public Sub editar_prod(cod_producto As String, cod As String, producto As String, cantidad As Integer, precio As Double)
        ...
        If validador > 0 Then
            ...
            comando = New SqlCommand("UPDATE producto SET cod_producto ='" & cod_producto & "', producto ='" & producto & "',cantidad ='" & cantidad & "',precio ='" & precio & "' where cod_producto= '" & cod & "'", conexion)
            comando.ExecuteNonQuery()
    ...
    'REGISTROS'
    Public Sub insertar_registro(id_producto As String, cantidad As Integer, n_factura As Integer, fecha As Date, usuario As String, tipo As String)

        conectar()

        comando = New SqlCommand("INSERT INTO  [registro]  ([id_producto], [cantidad], [n_factura], [fecha], [usuario], [tipo]) VALUES ('" & id_producto & "','" & cantidad & "','" & n_factura & "','" & fecha & "','" & usuario & "','" & tipo & "')", conexion)
        comando.ExecuteNonQuery()
    ...
    Sub eliminar_registro(id_pro As String, n_fac As String)
        ...
        comando = New SqlCommand("DELETE FROM registro WHERE id_producto ='" + id_pro + "' and n_factura ='" + n_fac + "'", conexion)
        comando.ExecuteNonQuery()
    ...
    'MERMAS'
    Public Sub insertar_mermas(cod_producto As String, producto As String, cantidad As Integer, fecha As Date)
        ...
        comando.ExecuteNonQuery()
        If validar > 0 Then
            comando = New SqlCommand("INSERT INTO [mermas] ([cod_producto], [nombre], [cantidad], [fecha]) VALUES ('" & cod_producto & "','" & producto & "','" & cantidad & "','" & fecha & "')", conexion)
            comando.ExecuteNonQuery()
            'MsgBox("El Producto: " & UCase(producto) & " ha sido ingresado con exito")
