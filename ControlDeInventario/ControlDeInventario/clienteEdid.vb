...
Public Class clienteEdid
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Rut_clienteTextBox.Text = ClienteDataGridView.CurrentRow.Cells.Item(1).Value.ToString
        NombreTextBox.Text = ClienteDataGridView.CurrentRow.Cells.Item(2).Value.ToString
        EmailTextBox.Text = ClienteDataGridView.CurrentRow.Cells.Item(3).Value.ToString
        FonoTextBox.Text = ClienteDataGridView.CurrentRow.Cells.Item(4).Value.ToString
        DireccionTextBox.Text = ClienteDataGridView.CurrentRow.Cells.Item(5).Value.ToString
        ComunaTextBox.Text = ClienteDataGridView.CurrentRow.Cells.Item(6).Value.ToString
        CiudadTextBox.Text = ClienteDataGridView.CurrentRow.Cells.Item(7).Value.ToString
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        For Each Fila As DataGridViewRow In ClienteDataGridView.Rows
            ...
            If Fila.Cells("eliminar").Value <> Nothing Then
                Dim rut As String = Fila.Cells(1).Value.ToString
                bdconexion.eliminar_cliente(rut)
