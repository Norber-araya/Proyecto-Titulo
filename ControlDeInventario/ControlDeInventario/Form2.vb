...
Public Class Form2
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        PrecioTextBox.Text = ProductoDataGridView.CurrentRow.Cells.Item(2).Value.ToString
        Tipo_productoTextBox.Text = ProductoDataGridView.CurrentRow.Cells.Item(3).Value.ToString
        CantidadTextBox.Text = ProductoDataGridView.CurrentRow.Cells.Item(4).Value.ToString
