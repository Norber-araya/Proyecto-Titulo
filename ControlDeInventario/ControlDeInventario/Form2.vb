...
Public Class Form2
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Cod_productoTextBox.Text = ProductoDataGridView.CurrentRow.Cells.Item(1).Value.ToString
        ProductoTextBox.Text = ProductoDataGridView.CurrentRow.Cells.Item(2).Value.ToString
        PrecioTextBox.Text = ProductoDataGridView.CurrentRow.Cells.Item(3).Value.ToString
        Tipo_productoTextBox.Text = ProductoDataGridView.CurrentRow.Cells.Item(4).Value.ToString
        CantidadTextBox.Text = ProductoDataGridView.CurrentRow.Cells.Item(5).Value.ToString
        cod = Cod_productoTextBox.Text
        MsgBox(cod)
    End Sub

    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If Cod_productoTextBox.Text = "" Or ProductoTextBox.Text = "" Or CantidadTextBox.Text = "" Or PrecioTextBox.Text = "" Or Tipo_productoTextBox.Text = "" Then
            MsgBox("Hay campos en blancos ")
        Else
            bdconexion.editar_prod(Cod_productoTextBox.Text, cod, ProductoTextBox.Text, PrecioTextBox.Text, Tipo_productoTextBox.Text, CantidadTextBox.Text)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        For Each Fila As DataGridViewRow In ProductoDataGridView.Rows
