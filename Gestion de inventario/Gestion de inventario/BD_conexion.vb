...
Public Class BD_conexion
    ...
    Public Sub editar_prod(cod_producto As String, producto As String, precio As String, cantidad As String, fecha_ui As String)
        ...
        desconectar()
    End Sub
    Public Sub actua_prod(cod_producto, cantidad)
        ...
        If validador > 0 Then
            ...
            comando.ExecuteNonQuery()
            MsgBox("El Producto: " & UCase(cod_producto) & " fue actualizado")
        Else

            MsgBox("El Producto: " & UCase(cod_producto) & " No existe en la base de datos")
