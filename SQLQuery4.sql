...
GO
/****** Object:  Table [dbo].[boleta]    Script Date: 04/07/2020 18:44:14 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[cliente]    Script Date: 04/07/2020 18:44:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[detalle_boleta]    Script Date: 04/07/2020 18:44:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[detalle_fac]    Script Date: 04/07/2020 18:44:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[detalle_proveedor]    Script Date: 04/07/2020 18:44:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[factura]    Script Date: 04/07/2020 18:44:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[mermas]    Script Date: 04/07/2020 18:44:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[producto]    Script Date: 04/07/2020 18:44:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[proveedor]    Script Date: 04/07/2020 18:44:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[registro]    Script Date: 04/07/2020 18:44:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tipousuario]    Script Date: 04/07/2020 18:44:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[usuario]    Script Date: 04/07/2020 18:44:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[boleta] ([n_boleta], [rut_empresa], [rut_cliente], [nombre_empresa], [direcion], [fecha], [total]) VALUES (200, N'44.300.251-0', NULL, N'MiOficinaS.A', N'Raul castellon #4565', CAST(N'2020-07-04' AS Date), 500.0000)
GO
INSERT [dbo].[boleta] ([n_boleta], [rut_empresa], [rut_cliente], [nombre_empresa], [direcion], [fecha], [total]) VALUES (234, N'44.300.251-0', NULL, N'MiOficinaS.A', N'Raul castellon #4565', CAST(N'2020-07-04' AS Date), 500.0000)
GO
INSERT [dbo].[boleta] ([n_boleta], [rut_empresa], [rut_cliente], [nombre_empresa], [direcion], [fecha], [total]) VALUES (3122, N'44.300.251-0', N'20435824', N'MiOficinaS.A', N'Raul castellon #4565', CAST(N'2020-07-04' AS Date), 500.0000)
GO
...
GO
INSERT [dbo].[producto] ([cod_producto], [nombre], [precio], [tipo_producto], [cantidad]) VALUES (N'GOM-001', N'Goma ', CAST(500 AS Decimal(20, 0)), N'oficina', 11)
GO
...
GO
INSERT [dbo].[producto] ([cod_producto], [nombre], [precio], [tipo_producto], [cantidad]) VALUES (N'RES-100', N'resma', CAST(1500 AS Decimal(20, 0)), N'oficina', 0)
GO
...
GO
INSERT [dbo].[registro] ([id_registro], [documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo]) VALUES (1, N'Boleta', 100, N'PER-021', 30, CAST(N'2020-07-04' AS Date), N'', N'venta')
GO
INSERT [dbo].[registro] ([id_registro], [documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo]) VALUES (2, N'Boleta', 100, N'GOM-001', 1, CAST(N'2020-07-04' AS Date), N'', N'venta')
GO
INSERT [dbo].[registro] ([id_registro], [documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo]) VALUES (3, N'Boleta', 100, N'GOM-001', 1, CAST(N'2020-07-04' AS Date), N'', N'venta')
GO
INSERT [dbo].[registro] ([id_registro], [documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo]) VALUES (5, N'Boleta', 100, N'GOM-001', 1, CAST(N'2020-07-04' AS Date), N'', N'venta')
GO
INSERT [dbo].[registro] ([id_registro], [documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo]) VALUES (6, N'Boleta', 100, N'RES-100', 1, CAST(N'2020-07-04' AS Date), N'', N'venta')
GO
INSERT [dbo].[registro] ([id_registro], [documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo]) VALUES (7, N'Boleta', 200, N'RES-100', 1, CAST(N'2020-07-04' AS Date), N'', N'venta')
GO
INSERT [dbo].[registro] ([id_registro], [documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo]) VALUES (16, N'Factura', 54, N'GOM-001', 1, CAST(N'2020-07-04' AS Date), N'', N'venta')
GO
INSERT [dbo].[registro] ([id_registro], [documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo]) VALUES (11, N'Boleta', 234, N'GOM-001', -1, CAST(N'2020-07-04' AS Date), N'', N'venta')
GO
INSERT [dbo].[registro] ([id_registro], [documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo]) VALUES (18, N'Boleta', 123, N'GOM-001', -1, CAST(N'2020-07-04' AS Date), N'', N'venta')
GO
INSERT [dbo].[registro] ([id_registro], [documento], [n_documento], [id_producto], [cantidad], [fecha], [usuario], [tipo]) VALUES (19, N'Boleta', 3122, N'GOM-001', -1, CAST(N'2020-07-04' AS Date), N'', N'venta')
GO
